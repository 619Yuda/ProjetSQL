...
ALTER TABLE Membre
    ALTER numero_membre SET DEFAULT nextval('seq_numero_membre'); -- en oracle seq_numero_membre.nextval

-- Même chose pour le numéro d'emprunt également

CREATE SEQUENCE seq_numero_emprunt START WITH 1 INCREMENT BY 1;
ALTER TABLE Emprunt
    ALTER numero_emprunt SET DEFAULT nextval('seq_numero_emprunt');
...
ALTER TABLE Membre
    ADD CONSTRAINT membre_unique UNIQUE (numero_membre, nom, prenom, telephone_portable);
